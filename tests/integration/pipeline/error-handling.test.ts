...
import { waitForSourceStatus, waitForSourceProcessing, sleep } from '../helpers.js';
...
describe('Error Handling & Retry Integration', () => {
  ...
  it(
    'should handle corrupted PDF as non-retryable',
    async () => {
  ...
  it(
    'should move permanently failed jobs to dead letter queue',
    async () => {
