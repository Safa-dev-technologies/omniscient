...
describe('E2E Pipeline Integration', () => {
  ...
  it(
    'should process DOCX end-to-end',
    async () => {
  ...
  it(
    'should process CSV/FAQ end-to-end',
    async () => {
  ...
  ); // Longer timeout for multiple files
});
