...
describe('Concurrent Operations Integration', () => {
  ...
  it('should handle 10 simultaneous uploads', async () => {
    const uploads = [];
  ...
  it('should handle duplicate job submissions (idempotent)', async () => {
    const pdfBuffer = createMinimalPDF();
    const result = await knowledgeService.uploadDocument({
      tenantId: TEST_CONFIG.tenantId,
  ...
  it('should handle parallel uploads from multiple tenants', async () => {
